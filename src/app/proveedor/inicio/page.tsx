...
// TODO: reemplazar por datos reales del backend cuando exista el endpoint de eventos recomendados
...
export default function InicioProveedorPage() {
  ...
  return (
    <div className="flex-1 overflow-y-auto no-scrollbar w-full">
      ...
      <section className="px-5">
        <div className="pb-6">
          <p className="text-festiva-midnight-blue/45 text-sm pb-2">Buenos dias, proveedor</p>
          <h1 className="text-festiva-midnight-blue font-bold text-3xl">{user?.nombre}</h1>
        </div>

        <StatsGrid
          ingresosMes="$48,500"
          ingresosVariacion="+18%"
          eventosActivos={7}
          eventosEnNegociacion={3}
          calificacion={4.9}
          cantidadResenas={124}
          tasaRespuesta="89%"
        />
