...
export default function ManagePortfolioView() {
    ...
    return (
        <div className="body">
            <TopBanner title="Gestionar Portafolio"/>

            <div style={{ padding: '42px 20px 24px', display: 'flex', flexDirection: 'column', gap: '18px' }}>
                
                <div className="bg-white p-1 rounded-[16px] border border-slate-100/50 shadow-[0_4px_20px_rgba(0,0,0,0.05)] grid grid-cols-2 text-center text-sm font-bold text-slate-400">
                    <button
